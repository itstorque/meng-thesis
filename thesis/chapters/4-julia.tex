...
\section{ODE Problems and Callbacks} \label{callbacks}
...
method used by \cf{DifferentialEquations.jl} \cite{diffeqjl_paper}. The \cf{DifferentialEquations.jl} solvers
...
\cf{Tsit5}. However, when the dynamics evolve to be more complicated, such as the hotspot heating a nanowire
...
\subsubsection{SNSPI Microstrip Self-Coupling}
